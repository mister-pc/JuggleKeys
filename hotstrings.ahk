...
:*:pb:: ; problËme
SendInput, {Left}ro{Right}lËme
Return
:*:pbm:: ; problËme (‡ partir de problËmem)
SendInput, {BackSpace}
Return
:*:pbmt::{Left}{BackSpace}{Left}{BackSpace}È{Right}a{Right}ique ; problÈmatique (‡ partir de problËmet)
:*:pbt::{Left}{BackSpace}{Left}{BackSpace}È{Right}a{Right}ique ; problÈmatique (‡ partir de problËmet)
